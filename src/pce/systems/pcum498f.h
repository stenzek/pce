...
class PCUM498F : public PCBase
{
public:
  PCUM498F(HostInterface* host_interface, CPU_X86::Model model = CPU_X86::MODEL_486, float cpu_frequency = 2000000.0f,
...
private:
  ...
  void IOReadUM498FIndexRegister(uint8* value);
  void IOWriteUM498FIndexRegister(uint8 value);
  void IOReadUM498FDataRegister(uint8* value);
  void IOWriteUM498FDataRegister(uint8 value);
  ...
  std::array<uint8, 256> m_UM498F_registers{};
  uint8 m_UM498F_index_register = 0;
  uint8 m_UM498F_unlock_stage = 2;
