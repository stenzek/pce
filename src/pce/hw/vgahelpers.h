...
enum : u8
{
  ...
  CRTC_REGISTER_MODE_CONTROL_ALTERNATE_LA13 = 0x01,
  CRTC_REGISTER_MODE_CONTROL_ALTERNATE_LA14 = 0x02,
  CRTC_REGISTER_MODE_CONTROL_LINE_COUNTER_MUL2 = 0x04,
  CRTC_REGISTER_MODE_CONTROL_COUNTBY2 = 0x08,
  CRTC_REGISTER_MODE_CONTROL_MEMORY_ADDRESS_OUTPUT_CONTROL = 0x10,
  CRTC_REGISTER_MODE_CONTROL_ALTERNATE_MA00 = 0x20,
  CRTC_REGISTER_MODE_CONTROL_BYTE_MODE = 0x40,
  CRTC_REGISTER_MODE_CONTROL_HOLD_MODE = 0x80,
};
...
enum : u8
{
  ...
  ATTRIBUTE_REGISTER_MODE_GRAPHICS_ENABLE = 0x01,
  ATTRIBUTE_REGISTER_MODE_MONO_EMULATION = 0x02,
  ATTRIBUTE_REGISTER_MODE_LINE_GRAPHICS_ENABLE = 0x04,
  ATTRIBUTE_REGISTER_MODE_BLINK_ENABLE = 0x8,
  ATTRIBUTE_REGISTER_MODE_PIXEL_PANNING_MODE = 0x20,
  ATTRIBUTE_REGISTER_MODE_HALF_PIXEL_CLOCK = 0x40,
  ATTRIBUTE_REGISTER_MODE_PALETTE_BITS_5_4 = 0x80,
...
#define SEQUENCER_REGISTER_CLOCKING_MODE_DOT8(val) ((val & 0x01) != 0)
#define SEQUENCER_REGISTER_CLOCKING_MODE_DOT_CLOCK_DIV2(val) ((val & 0x08) != 0)

#define SEQUENCER_REGISTER_CHARACTER_MAP_SELECT_B(val) (((val)&0x03) | (((val) >> 2) & 0x04))
#define SEQUENCER_REGISTER_CHARACTER_MAP_SELECT_A(val) ((((val >> 2)) & 0x03) | (((val) >> 3) & 0x04))
