...
#define SET_FLAG(regs, flag, expr)                                                                                     \
  ...
  static inline void Dispatch_Prefix_80(CPU* cpu);
  static inline void Dispatch_Prefix_81(CPU* cpu);
  static inline void Dispatch_Prefix_82(CPU* cpu);
  static inline void Dispatch_Prefix_83(CPU* cpu);
  static inline void Dispatch_Prefix_d0(CPU* cpu);
  static inline void Dispatch_Prefix_d1(CPU* cpu);
  static inline void Dispatch_Prefix_d2(CPU* cpu);
  static inline void Dispatch_Prefix_d3(CPU* cpu);
  static inline void Dispatch_Prefix_f6(CPU* cpu);
  static inline void Dispatch_Prefix_f7(CPU* cpu);
  static inline void Dispatch_Prefix_fe(CPU* cpu);
  static inline void Dispatch_Prefix_ff(CPU* cpu);
};
...
void Instructions::DispatchInstruction(CPU* cpu)
{
  for (;;)
  {
...
void Instructions::Dispatch_Prefix_80(CPU* cpu)
{
  FetchModRM(cpu);
...
void Instructions::Dispatch_Prefix_81(CPU* cpu)
{
  FetchModRM(cpu);
  switch (cpu->idata.GetModRM_Reg() & 0x07)
  {
    EnumGrp1Opcodes(Ew, Iw)
  }
}

void Instructions::Dispatch_Prefix_82(CPU* cpu)
{
  FetchModRM(cpu);
  switch (cpu->idata.GetModRM_Reg() & 0x07)
  {
...
void Instructions::Dispatch_Prefix_83(CPU* cpu)
{
  FetchModRM(cpu);
  switch (cpu->idata.GetModRM_Reg() & 0x07)
  {
    EnumGrp1Opcodes(Ew, Ib)
  }
}

void Instructions::Dispatch_Prefix_d0(CPU* cpu)
{
  FetchModRM(cpu);
  switch (cpu->idata.GetModRM_Reg() & 0x07)
  {
...
void Instructions::Dispatch_Prefix_d1(CPU* cpu)
{
  FetchModRM(cpu);
  switch (cpu->idata.GetModRM_Reg() & 0x07)
  {
    EnumGrp2Opcodes(Ew, Cb(1))
  }
}

void Instructions::Dispatch_Prefix_d2(CPU* cpu)
{
  FetchModRM(cpu);
  switch (cpu->idata.GetModRM_Reg() & 0x07)
  {
...
void Instructions::Dispatch_Prefix_d3(CPU* cpu)
{
  FetchModRM(cpu);
  switch (cpu->idata.GetModRM_Reg() & 0x07)
  {
    EnumGrp2Opcodes(Ew, CL)
  }
}

void Instructions::Dispatch_Prefix_f6(CPU* cpu)
{
  FetchModRM(cpu);
  switch (cpu->idata.GetModRM_Reg() & 0x07)
  {
...
void Instructions::Dispatch_Prefix_f7(CPU* cpu)
{
  FetchModRM(cpu);
  switch (cpu->idata.GetModRM_Reg() & 0x07)
  {
...
void Instructions::Dispatch_Prefix_fe(CPU* cpu)
{
  FetchModRM(cpu);
  switch (cpu->idata.GetModRM_Reg() & 0x07)
  {
...
void Instructions::Dispatch_Prefix_ff(CPU* cpu)
{
  FetchModRM(cpu);
  switch (cpu->idata.GetModRM_Reg() & 0x07)
  {
