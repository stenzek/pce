...
#include "pce/cpu_x86/new_interpreter.inl"
#include "pce/cpu_x86/new_interpreter_x87.inl"
...
void Decoder::DisassembleToString(const Instruction* instruction, String* out_string)
{
  ...
  for (; operand_index < countof(instruction->operands); operand_index++)
  {
    ...
    const OperandSize size = (operand.size == OperandSize_Count) ? instruction->data.operand_size : operand.size;
    switch (operand.mode)
    {
...
#define MakeNop(opcode) { Operation_NOP, {}, &NewInterpreter::Execute_Operation_NOP, nullptr },
#define MakeNoOperands(opcode, inst) { inst, {}, &NewInterpreter::Execute_##inst, nullptr },
#define MakeOneOperand(opcode, inst, op1) { inst, { {op1} }, &NewInterpreter::Execute_##inst<op1>, nullptr },
#define MakeOneOperandCC(opcode, inst, cc, op1) { inst, { { OperandSize_Count, OperandMode_JumpCondition, cc}, {op1} }, &NewInterpreter::Execute_##inst<cc, op1>, nullptr },
#define MakeTwoOperands(opcode, inst, op1, op2) { inst, { {op1}, {op2} }, &NewInterpreter::Execute_##inst<op1, op2>, nullptr },
#define MakeTwoOperandsCC(opcode, inst, cc, op1, op2) { inst, { { OperandSize_Count, OperandMode_JumpCondition, cc}, {op1}, {op2} }, &NewInterpreter::Execute_##inst<cc, op1, op2>, nullptr },
#define MakeThreeOperands(opcode, inst, op1, op2, op3) { inst, { {op1}, {op2}, {op3} }, &NewInterpreter::Execute_##inst<op1, op2, op3>, nullptr },
