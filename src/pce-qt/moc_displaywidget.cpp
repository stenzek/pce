...
#define QT_MOC_LITERAL(idx, ofs, len)                                                                                  \
  Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(                                                             \
    len, qptrdiff(offsetof(qt_meta_stringdata_DisplayWidget_t, stringdata0) + ofs - idx * sizeof(QByteArrayData)))
static const qt_meta_stringdata_DisplayWidget_t qt_meta_stringdata_DisplayWidget = {
  {
    ...
    QT_MOC_LITERAL(5, 45, 13)  // "onKeyReleased"

  },
  "DisplayWidget\0onKeyPressed\0\0QKeyEvent*\0"
  "event\0onKeyReleased"};
...
// SIGNAL 0
void DisplayWidget::onKeyPressed(QKeyEvent* _t1)
{
...
// SIGNAL 1
void DisplayWidget::onKeyReleased(QKeyEvent* _t1)
{
  void* _a[] = {Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1))};
