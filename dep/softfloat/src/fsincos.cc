...
static const floatx80 floatx80_one = packFloatx80(0, 0x3fff, UINT64_C(0x8000000000000000));
...
/* 0 <= x <= pi/4 */
inline float128 poly_sin(float128 x, float_status_t &status)
{
    //                 3     5     7     9     11     13     15
    //                x     x     x     x     x      x      x
    // sin (x) ~ x - --- + --- - --- + --- - ---- + ---- - ---- =
...
/* 0 <= x <= pi/4 */
inline float128 poly_cos(float128 x, float_status_t &status)
{
    //                 2     4     6     8     10     12     14
    //                x     x     x     x     x      x      x
    // cos (x) ~ 1 - --- + --- - --- + --- - ---- + ---- - ----
