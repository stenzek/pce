...
static const floatx80 floatx80_negone  = packFloatx80(1, 0x3fff, UINT64_C(0x8000000000000000));
static const floatx80 floatx80_neghalf = packFloatx80(1, 0x3ffe, UINT64_C(0x8000000000000000));
static const float128 float128_ln2     =
    packFloat128(UINT64_C(0x3ffe62e42fefa39e), UINT64_C(0xf35793c7673007e6));
