...
static const float128 float128_one =
        packFloat128(UINT64_C(0x3fff000000000000), UINT64_C(0x0000000000000000));
static const float128 float128_sqrt3 =
        packFloat128(UINT64_C(0x3fffbb67ae8584ca), UINT64_C(0xa73b25742d7078b8));
static const floatx80 floatx80_pi  =
        packFloatx80(0, 0x4000, UINT64_C(0xc90fdaa22168c235));

static const float128 float128_pi2 =
        packFloat128(UINT64_C(0x3fff921fb54442d1), UINT64_C(0x8469898CC5170416));
static const float128 float128_pi4 =
        packFloat128(UINT64_C(0x3ffe921fb54442d1), UINT64_C(0x8469898CC5170416));
static const float128 float128_pi6 =
        packFloat128(UINT64_C(0x3ffe0c152382d736), UINT64_C(0x58465BB32E0F580F));
...
return_PI_or_ZERO:
    ...
    if (x.hi >= UINT64_C(0x3ffe800000000000))        // 3/4 < x < 1
    {
        /*
