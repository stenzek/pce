...
jit_float32 jit_float32_ieee_rem(jit_float32 value1, jit_float32 value2)
{
  ...
  else if ((floor(ceil_value / (jit_float32)2.0) * (jit_float32)2.0) == ceil_value)
  {
    temp = ceil_value;
  }
  else
...
jit_float64 jit_float64_ieee_rem(jit_float64 value1, jit_float64 value2)
{
  ...
  else if ((floor(ceil_value / (jit_float64)2.0) * (jit_float64)2.0) == ceil_value)
  {
    temp = ceil_value;
  }
  else
...
#elif defined(HAVE_FMOD)
  return fmod(value1, value2);
#elif defined(HAVE_CEILL) && defined(HAVE_FLOORL) && !defined(JIT_NFLOAT_IS_DOUBLE)
...
jit_nfloat jit_nfloat_ieee_rem(jit_nfloat value1, jit_nfloat value2)
{
  ...
  else if ((floor(ceil_value / (jit_nfloat)2.0) * (jit_nfloat)2.0) == ceil_value)
  {
    temp = ceil_value;
  }
  else
...
jit_int jit_nfloat_is_finite(jit_nfloat value)
{
  ...
  return finite(value);
#else /* !HAVE_FINITE */
#if defined(HAVE_ISNANL) && defined(HAVE_ISINFL) && !defined(JIT_NFLOAT_IS_DOUBLE)
...
jit_int jit_float32_to_int_ovf(jit_int* result, jit_float32 value)
{
  if (jit_float32_is_finite(value))
  {
    if (value > (jit_float32)(-2147483649.0) && value < (jit_float32)2147483648.0)
    {
...
jit_int jit_float32_to_uint_ovf(jit_uint* result, jit_float32 value)
{
  if (jit_float32_is_finite(value))
  {
    if (value >= (jit_float32)0.0 && value < (jit_float32)4294967296.0)
    {
...
jit_int jit_float32_to_long_ovf(jit_long* result, jit_float32 value)
{
  if (jit_float32_is_finite(value))
  {
    if (value >= (jit_float32)-9223372036854775808.0 && value < (jit_float32)9223372036854775808.0)
    {
...
jit_int jit_float64_to_int_ovf(jit_int* result, jit_float64 value)
{
  if (jit_float64_is_finite(value))
  {
    if (value > (jit_float64)(-2147483649.0) && value < (jit_float64)2147483648.0)
    {
...
jit_int jit_float64_to_uint_ovf(jit_uint* result, jit_float64 value)
{
  if (jit_float64_is_finite(value))
  {
    if (value >= (jit_float64)0.0 && value < (jit_float64)4294967296.0)
    {
...
jit_int jit_float64_to_long_ovf(jit_long* result, jit_float64 value)
{
  if (jit_float64_is_finite(value))
  {
    if (value >= (jit_float64)-9223372036854775808.0 && value < (jit_float64)9223372036854775808.0)
    {
...
jit_int jit_nfloat_to_int_ovf(jit_int* result, jit_nfloat value)
{
  if (jit_nfloat_is_finite(value))
  {
    if (value > (jit_nfloat)(-2147483649.0) && value < (jit_nfloat)2147483648.0)
    {
...
jit_int jit_nfloat_to_uint_ovf(jit_uint* result, jit_nfloat value)
{
  if (jit_nfloat_is_finite(value))
  {
    if (value >= (jit_nfloat)0.0 && value < (jit_nfloat)4294967296.0)
    {
...
jit_int jit_nfloat_to_long_ovf(jit_long* result, jit_nfloat value)
{
  if (jit_nfloat_is_finite(value))
  {
    if (value >= (jit_nfloat)-9223372036854775808.0 && value < (jit_nfloat)9223372036854775808.0)
    {
...
jit_float32 jit_ulong_to_float32(jit_ulong value)
{
  ...
  {
    return (jit_float32)((jit_long)value) + (jit_float32)18446744073709551616.0;
  }
}
...
jit_float64 jit_ulong_to_float64(jit_ulong value)
{
  ...
  {
    return (jit_float64)((jit_long)value) + (jit_float64)18446744073709551616.0;
  }
}
...
jit_nfloat jit_ulong_to_nfloat(jit_ulong value)
{
  ...
  {
    return (jit_nfloat)((jit_long)value) + (jit_nfloat)18446744073709551616.0;
  }
}
